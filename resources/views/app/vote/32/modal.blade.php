...
<section class="rule_box clearfix box_hide modal-box">
    <div class="rule_box_main clearfix modal-box-main">
        <div class="msg_box">
            <p><b>—&nbsp;活动规则&nbsp;—</b></p>
            <p>1、每位用户将有15票的投选机会，关注以下公众号，每个公众号分别提供5票的投选机会。【四川省预防医学会】、【四川疾控】、【成都商报四川名医】。三个公众号票数之和将是最终得票。</p>
            <p>2、投票结束后，根据最终得票数计算的网络得票分数；网络得票分数将占选手最终得分的10%。</p>
            <p>3、评选期间将严格监控投票数据，如若发现刷票行为，一经查实，将立即取消评选资格。</p>
            <p>4、本投票从2018年10月22日14：00启动-2018年10月23日12:00截止</p>
        </div>
    </div>
