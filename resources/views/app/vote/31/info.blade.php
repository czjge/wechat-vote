...
@section('content')
    ...
    <div class="video-content">
        <video controls="controls" width="100%" poster="{{ $qiniu_cdn_path }}/images/vote/{{ $vote->id }}/info/{{ $candidate->name }}.png">
            <source src="http://cdn.mp.doctorofsc.cn/video/{{ $candidate->id-428-24 }}.mp4" type="video/mp4">
        </video>
    </div>
@endsection
...
//        })
        ...
        function showShareGuide(){
            ...
            $('body').append('<div id="share_guide_box" onclick="hideShareGuide();" style="position:fixed;z-index:80;left:0px;top:0px;width:100%;height:100%;background-color: rgba(0,0,0,0.8);text-align:right;" ontouchmove="return true;" ><img src="'+imagespath+'/vote/31/yf-code.jpg" width="100%"></div>');
            shareGuideFlag = 1;
        }
