            ...
            <div class="doc-item">
                ...
                <div class="doc-info">
                    ...
                    <div class="btuns">
                        ...
                        @endif
                        @if (explode('@', $candidate->registration_left_num)[1] != '')
                        <div class="grabnum-btn mrg-left" data-id="{{ $candidate->id }}" data-time="xw">
                            <i class="icon-num"></i> 下午<span>(余<span class="regis-num">{{ explode('@', $candidate->registration_left_num)[1] }}</span>)</span>
                        </div>
                        @endif
                    </div>
                </div>
