...
@section('content')
    <section class="top_box clearfix">
        ...
        <p class="vote_time">10月10日~10月16日</p>
        <p class="vote-title">10&nbsp;&nbsp;/&nbsp;&nbsp;强&nbsp;&nbsp;/&nbsp;&nbsp;评&nbsp;&nbsp;/&nbsp;&nbsp;选&nbsp;&nbsp;/&nbsp;&nbsp;活&nbsp;&nbsp;/ &nbsp;&nbsp;动</p>
        ...
        <div class="banner-content">
            ...
            <div class="swiper-container"><!--swiper容器[可以随意更改该容器的样式-->  
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=0"><img src="{{ $qiniu_cdn_path }}/images/vote/3/tuijian1.jpg"></a></div>  
                    <div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=1"><img src="{{ $qiniu_cdn_path }}/images/vote/3/tuijian2.jpg"></a></div>
					<div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=3"><img src="{{ $qiniu_cdn_path }}/images/vote/3/tuijian3.jpg"></a></div>
                </div>
