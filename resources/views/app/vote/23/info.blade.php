...
@section('content')
    <div class="nav-bar">
        <div class="nav-bar-inner">
            <a class="nav-back" href="{{ route('home.vote.getIndex'.Input::get('id')) }}?id={{ Input::get('id') }}"><i class="icon-back"></i><span>返回</span> </a>
            <span class="nav-title"></span>
        </div>
    </div>
    <div class="info-head">
        <div class="info-head-inner">
    ...
    <div class="info-intr">
        ...
        <div class="info-depart">{{ $candidate->title }} | {{ $candidate->desc }}</div>
        <div class="info-depart info-hos">{{ $candidate->hospital }}</div>
    </div>
...
@section('selfjs')
    ...
    <script type="application/javascript">
        ...
        function showShareGuide(){
            ...
            $('body').append('<div id="share_guide_box" onclick="hideShareGuide();" style="position:fixed;z-index:80;left:0px;top:0px;width:100%;height:100%;background-color: rgba(0,0,0,0.8);text-align:right;" ontouchmove="return true;" ><img src="'+imagespath+'/jkcd_qrcode.jpg" width="100%"></div>');
            shareGuideFlag = 1;
        }
