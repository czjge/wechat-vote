...
<section class="rule_box clearfix box_hide modal-box act-rules-modal">
    <div class="rule_box_main clearfix modal-box-main">
        <div class="msg_box">
            <p><b>—&nbsp;活动规则&nbsp;—</b></p>
            <p>1、评选对象： 第一阶段评选出的各个专科专病榜前十的医生。</p>
            <p>2、评选方式：投票结果由市民投票（40%）+专家评审团投票（60%）组成，共同评选出“第六届 妙手仁心·金口碑 十强好医生”，专家评审团拥有一票否决权。</p>
            <p>3、专家评审团将从第一阶段66位专家评审中，随机抽选11位专家共同组成。</p>
            <p>4、投票规则：每个微信号每天最多点赞5次，可为多位医生投票；每位医生每天得票数上限是5万票且每5分钟得到票数上限是1000票（超过限制，将会被自动锁定2小时）；服务器承载能力有限，如果出现投票过于集中，页面延迟，请稍后再试。</p>
            <p>5、注意：评选期间，主办方将严格核查报名信息及投票数据，如若发现报名信息作假或刷票行为，一经查实，将立即取消评选资格。</p>
            <p>6、本轮投票时间：2018年9月24日7:00开始，到2018年10月8日18:00截止。</p>
            <p>7、最终评选结果，将于10月中旬在《成都商报》上进行公布。</p>
            <p>8、本活动最终解释权归成都商报四川名医所有，咨询电话：028-69982575。</p>
        </div>
    </div>
    <div class="close_box rule_box_close" onclick="closeRules()"></div>
</section>
