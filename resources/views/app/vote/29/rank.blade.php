...
@section('content')
    ...
    <div class="choose-content">
        {{--<div class="choose-btn"><div class="btn-circle left"></div>专科专病榜<div class="btn-circle right"></div></div>--}}
        <div class="choose-btn active" id="ysbd">医生榜单</div>
                ...
                @foreach($doc_list as $key => $doc_item)
                    <li>
                        <a href="{{ route('home.vote.getInfo'.Input::get('id'), ['cid' => $doc_item->doc_id]) }}?id={{ Input::get('id') }}">
                            ...
                            <div class="record-votes">{{ $doc_item->doc_num }}票</div>
                        </a>
                    </li>
                @endforeach
