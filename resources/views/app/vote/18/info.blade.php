...
@section('content')
    ...
    <div class="main-img">
        <img src="{{ $qiniu_cdn_path }}/images/vote/{{ Input::get('id') }}/info/{{ $candidate->name }}.png">
        {{--<img src="{{ $qiniu_cdn_path }}/images/vote/18/doc-zl.png">--}}
    </div>
    <div class="info-content">
        <div class="info-num first">已影响</div>
        <div class="info-num sec"><span class="num">{{ $candidate->num }}</span>人</div>
    </div>
    <div class="btn-content"> <div class="info-btn">给Ta点赞</div></div>
    <a href="{{ route('home.vote.getIndex'.Input::get('id')) }}?id={{ Input::get('id') }}" class="return-btn">
