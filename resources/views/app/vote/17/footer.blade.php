...
<footer class="footer_main clearfix">
    <ul class="clearfix">
        ...
        <li><a href="{{ route('home.vote.getLog'.Input::get('id')) }}?id={{ Input::get('id') }}"><div class="icon-img icon-rule"></div><span class="nav">投票记录</span></a></li>
        <li class="footer-search"><a href="javascript:void(0);"><div class="icon-img icon-search"></div><span class="nav">搜索</span></a></li>
        <li class="footer_nav_gz"><a href="javascript:void(0);" onclick="showShareGuide();"><div class="icon-img icon-we"></div><span class="nav">我们</span></a></li>
    </ul>
</footer>
