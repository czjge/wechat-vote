...
@section('content')
    ...
    <ul class="main-content clearfix edit">
        ...
        <li>
            ...
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入您的职称" name="title" value="{{ $candidate->title }}"></div>
        </li>
        <li>
            <span class="li-title">科室</span>
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入您的科室" name="department" value="{{ $candidate->department }}"></div>
        </li>
        <li>
            <span class="li-title">医院</span>
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入医院名称" name="hospital" value="{{ $candidate->hospital }}"></div>
        </li>
        <li>
