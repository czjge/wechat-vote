...
@section('content')
    ...
    <ul class="main-content clearfix">
        ...
        <li>
            ...
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入您的姓名" name="name"></div>
        </li>
        <li>
            <span class="li-title">手机</span>
            <div class="li-right"><input class="li-input" type="number" placeholder="请输入您的手机号（选填）" name="mobile"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入您的职称" name="title"></div>
        </li>
        <li>
            <span class="li-title">科室</span>
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入您的科室" name="department"></div>
        </li>
        <li>
            <span class="li-title">医院</span>
            <div class="li-right"><input class="li-input" type="text" placeholder="请输入医院名称" name="hospital"></div>
        </li>
        <li>
            <span class="li-title long">医生简介</span>
            <div class="li-box">
                <textarea class="li-profile" name="desc"></textarea>
...
//        });
        ...
        $(".save-btn").click( function () {
            ...
            var department = $('[name=department]').val().trim();
            var hospital = $('[name=hospital]').val().trim();
