...
@section('content')
    <section class="top_box clearfix"><img src="{{ $qiniu_cdn_path }}/images/vote/5/rank-banner.jpg" width="100%"></section>
    
    <section class="select_section">
        <div class="box_select">
            <a href="{{ route('home.vote.getRank'.$id) }}?id={{ $id }}&type=0" @if(Input::get('type')==0)class="active"@endif >儿科西医榜</a>
            <a href="{{ route('home.vote.getRank'.$id) }}?id={{ $id }}&type=1" @if(Input::get('type')==1)class="active"@endif >儿科中医榜</a>
        </div>
