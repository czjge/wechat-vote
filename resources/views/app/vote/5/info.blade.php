...
@section('content')
    <section class="top_box clearfix">
        <img src="{{ $qiniu_cdn_path }}/images/vote/5/info-bg.jpg" width="100%">
    ...
    <section class="footer_info info-vote <?php if($candidate->type==2){echo 'box_hide';}?>">
        <p>已有 <span class="num">{{ $candidate->num }}</span> 人为TA投票</p>
        <a href="javascript:void(0);"><div class="main_btn">投TA一票</div></a>
    </section>

    <section class="info-main clearfix <?php if($candidate->type!=2){echo 'top-970';}?>"><!--专家时去掉‘top-970’-->
