...
@section('content')
    <div class="head-info">
        <div class="banner-info"><img src="@if(''==$candidate->pic_url) {{ $qiniu_cdn_path }}/images/default_doc_avatar.jpg @elseif(false !== strpos($candidate->pic_url, 'https')) {{ $candidate->pic_url }} @else {{ $qiniu_cdn_path }}/storage/{{ $candidate->pic_url }} @endif"> </div>
        <div class="item-info">
            <div class="item-bar">
                <div class="fa-i ellipsis">{{ $candidate->name }}</div>
                <div class="fa-d ellipsis">{{ $candidate->address }}</div>
            </div>
        </div>
    </div>
    <div class="tag-info"></div>
    <p class="text-i">{{ $candidate->desc }}</p>
    <div class="ri-btn zan-i">给TA点赞</div>
...
@section('selfjs')
    ...
    <script type="application/javascript">
        $(function () {
            ...
            $('.zan-i, #captcha_code_btn').click(function () {
