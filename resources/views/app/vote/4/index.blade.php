...
@section('content')
    ...
    <section class="top_box clearfix">
        <img src="{{ $qiniu_cdn_path }}/images/vote/4/index-bg.jpg" width="100%">
        <a href="javascript:void(0);"><span class="rule_info" style="z-index:70;"></span></a>
                ...
                @foreach ($candidates as $candidate)
                    <div class="list_item index_list_item list-item-right">
                        <a href="{{ route('home.vote.getInfo'.$id, ['cid'=>$candidate->id]) . '?id=' . $id }}">
                            <div class="head-img"><img src="{{ $qiniu_cdn_path }}/images/vote/{{ $id }}/cover/index/{{ $candidate->no }}.jpg"/></div>
                            <div class="title">
                                <p class="title-first">
                                    <span class="xm">{{ $candidate->name }}</span>
                                    <span class="zc">{{ $candidate->of_dep }}</span>
                                </p>
                            </div>
                            <div class="lrc_box">
                                <span class="lrc">{{ $candidate->desc }}</span>
                            </div>
                            <div class="msg_box">
                                <label>
        ...
        <div class="banner-content">
            <div class="swiper-container"><!--swiper容器[可以随意更改该容器的样式-->
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=0"><img src="{{ $qiniu_cdn_path }}/images/vote/4/tuijian1.jpg"></a></div>  
                    <div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=1"><img src="{{ $qiniu_cdn_path }}/images/vote/4/tuijian1.jpg"></a></div>
                    <div class="swiper-slide"><a href="https://cdsb.scmingyi.cn/vote/index?id=2&type=3"><img src="{{ $qiniu_cdn_path }}/images/vote/4/tuijian1.jpg"></a></div>
                </div>
