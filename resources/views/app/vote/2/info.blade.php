...
@section('selfcss')
    ...
    <style>
        ...
        .info-main-title{
            ...
            line-height: 60px;
            width: 100%;
            background: url("{{ $qiniu_cdn_path }}/images/vote/2/red-con.png") no-repeat top center ;
            text-align: center;
...
@section('content')
    ...
    <section class="info_top list_box clearfix">
        <div class="info-part01 list_item">
            <div class="head-img"><img src="<?php if($candidate->doctor_avatar==''){echo $qiniu_cdn_path.'/images/default_doc_avatar.jpg';}else{echo 'http://qiniu.langzoo.com'.$candidate->doctor_avatar;}?>"/></div>
            <div class="title">
                <p class="title-first">
