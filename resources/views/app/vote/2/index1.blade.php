...
@section('content')
    ...
    <section class="top_box clearfix">
        ...
        <a class="top-search position-r footer_nav_search" href="javascript:void(0);"><i class="top-search-icon search-icon"></i> <input type="text" class="top-search-input" placeholder="搜索疾病" disabled></a>
    </section>
    ...
    <section class="banner_section">
        <div class="section-content">
            <ul class="list-block">
                @foreach ($retval as $disease)
                <li class="clear">
                    <a href="{{ route('home.vote.getRank'.$id).'?id='.$id.'&type=1&disease='.$disease->disease_name }}" class="clear">
                        <span class="section-name mrg-l0 mrg-t0 wid-middle">{{ $disease->disease_name }}</span>
                        <div class="float-right">
                            <span class="section-num">{{ $disease->doctor_count }}人</span>
