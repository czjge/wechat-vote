            ...
            <div class="phb_box_table mzy-phb clearfix">
                ...
                <div class="list_item">
                    <a href="{{ $item->url }}">
                        ...
                        <div class="head-img"><img <?php if($item->type>0){echo 'style="height: 100%;"';}?> src='<?php echo $item->pic_url ? (strpos($item->pic_url, 'http')===false ? $qiniu_cdn_path.'/storage/'.$item->pic_url : $item->pic_url) : $qiniu_cdn_path.'/images/default_doc_avatar.jpg';?>?v=2'/></div>
                         <!--<div class="head-img"><img src='/images/vote/header.jpg'/></div>-->
                        <div class="title">
                            @if($item->type==0)
                                <p class="title-first">
                                    <span class="xm">{{ $item->of_dep }}</span>
                                </p>
                            @else
                                <p class="title-first">
                                    <span class="xm">{{ $item->of_hospital }}</span>
                                </p>
                            @endif
