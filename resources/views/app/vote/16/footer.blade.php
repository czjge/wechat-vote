...
<footer class="footer_main clearfix">
    <ul class="clearfix">
        <li class="footer_nav_index"><a href="{{ route('home.vote.getIndex'.\Illuminate\Support\Facades\Input::get('id')) }}?id={{ \Illuminate\Support\Facades\Input::get('id') }}&type=0"><span class="nav">首页</span></a></li>
