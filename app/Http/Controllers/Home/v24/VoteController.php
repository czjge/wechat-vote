...
namespace App\Http\Controllers\Home\v24;
...
use App\Repositories\vote\v24\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.24';
    private $rankListCacheKey = 'scmy.vote.rank.list.24';
    protected $voteRep;
