...
namespace App\Http\Controllers\Home\v31;
...
use App\Repositories\vote\v31\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.31';
    private $rankListCacheKey = 'scmy.vote.rank.list.31';
    protected $voteRep;
