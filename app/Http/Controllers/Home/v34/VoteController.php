...
namespace App\Http\Controllers\Home\v34;
...
use App\Repositories\vote\v34\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.34';
    private $rankListCacheKey = 'scmy.vote.rank.list.34';
    protected $voteRep;
