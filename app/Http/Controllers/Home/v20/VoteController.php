...
namespace App\Http\Controllers\Home\v20;
...
use App\Repositories\vote\v20\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.20';
    private $rankListCacheKey = 'scmy.vote.rank.list.20';
    protected $voteRep;
