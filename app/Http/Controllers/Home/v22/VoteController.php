...
namespace App\Http\Controllers\Home\v22;
...
use App\Repositories\vote\v22\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.22';
    private $rankListCacheKey = 'scmy.vote.rank.list.22';
    protected $voteRep;
...
//        }
        ...
        return view('app.vote.'.$id.'.index', [
            ...
            'shareInfo' => [
                ...
                'shareUrl'   => 'http://j01.scmingyi.cn/index.php?id=' . $id,
    ...
    public function getInfo (Request $request, $cid) {
        ...
        return view('app.vote.'.$id.'.info', [
            ...
            'shareInfo' => [
                ...
                //'shareUrl'   => 'http://j01.scmingyi.cn/index.php?info=' . $cid . '&id=' . $id,
            ],
        ]);
    }
