...
namespace App\Http\Controllers\Home\v25;
...
use App\Repositories\vote\v25\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.25';
    private $rankListCacheKey = 'scmy.vote.rank.list.25';
    protected $voteRep;
    ...
    public function getIndex (Request $request) {
		header('Location: https://mp.doctorofsc.cn/vote/index?id=26');
