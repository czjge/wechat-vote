...
namespace App\Http\Controllers\Home\v28;
...
use App\Repositories\vote\v28\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.28';
    private $rankListCacheKey = 'scmy.vote.rank.list.28';
    protected $voteRep;
...
//        }
    ...
    public function getRank (Request $request) {
        ...
        $dep_list_raw = [
            ...
            '泌尿外科','胸心外科','神经外科','妇科','产科','眼科','儿科','口腔科','整形外科','美容皮肤科','精神心理科','感染传染科','肿瘤科','生殖科',
