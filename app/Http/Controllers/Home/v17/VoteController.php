...
namespace App\Http\Controllers\Home\v17;
...
use App\Repositories\vote\v17\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.17';
    private $rankListCacheKey = 'scmy.vote.rank.list.17';
    protected $voteRep;
