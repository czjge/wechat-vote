...
namespace App\Http\Controllers\Home\v30;
...
use App\Repositories\vote\v30\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.30';
    private $rankListCacheKey = 'scmy.vote.rank.list.30';
    protected $voteRep;
