...
namespace App\Http\Controllers\Home\v23;
...
use App\Repositories\vote\v23\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.23';
    private $rankListCacheKey = 'scmy.vote.rank.list.23';
    protected $voteRep;
