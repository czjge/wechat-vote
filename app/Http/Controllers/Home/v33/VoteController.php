...
namespace App\Http\Controllers\Home\v33;
...
use App\Repositories\vote\v33\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.33';
    private $rankListCacheKey = 'scmy.vote.rank.list.33';
    protected $voteRep;
