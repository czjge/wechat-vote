...
namespace App\Http\Controllers\Home\v4;
...
use App\Repositories\vote\v4\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.4';
    private $rankListCacheKey = 'scmy.vote.rank.list.4';
