...
namespace App\Http\Controllers\Home\v21;
...
use App\Repositories\vote\v21\VoteRepository as voteRep;
...
class VoteController extends HomeBaseController
{
    ...
    private $indexListCacheKey = 'scmy.vote.index.list.21';
    private $rankListCacheKey = 'scmy.vote.rank.list.21';
    protected $voteRep;
