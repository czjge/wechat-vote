...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        // because zizaco/entrust bundle doesn't support multiple users,
        ...
        'ability.check' => \App\Http\Middleware\AbilityCheck::class,

        // wechat
        'wechatauth' => \App\Http\Middleware\WeChatAuthenticate::class,

        // cdn check.
        'cdn' => \App\Http\Middleware\CdnCheck::class,
